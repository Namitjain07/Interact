package com.interact.interact.utils
...
import com.interact.interact.RobotoFont
...
class HelperClass {
    ...
    fun callStatsPopupDisplay(
        ...
        timer.schedule(object : TimerTask() {
            ...
            override fun run() {
                ...
                if (score >= 7) {
                    ...
                    linearLayoutView.setBackgroundColor("#3BA55D".toColorInt())
        ...
        popupWindow.setBackgroundDrawable(
            ContextCompat.getDrawable(context, R.drawable.linearlayout_style)
        )
